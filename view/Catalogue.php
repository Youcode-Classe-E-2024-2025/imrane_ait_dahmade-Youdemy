...
<div class="card flex-1 " style=" ">
  ...
  <div class="card-body">
    <h5 class="card-title"><?= htmlspecialchars($cour['NomCour']) ?></h5>
    <p class="card-text"><?= htmlspecialchars($cour['Description'])?></p>
    <a class="card-text"><?= htmlspecialchars($cour['Categorie'])?></a>
